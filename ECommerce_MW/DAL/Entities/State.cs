...
namespace ECommerce_MW.DAL.Entities
{
    ...
    {
        [Display(Name = "Estado")]//Como quiero mostrar esta propiedad a nivel de interfaz grafica de usuario
        ...
        public Country Country { get; set; }//Un estado solo pertenece a un pais
